          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="list-unstyled">
                <li className="mb-2">
                  <small>
                    <strong>Serial Number:</strong> Must be unique for each equipment
                  </small>
                </li>
                <li className="mb-2">
                  <small>
                    <strong>Criticality:</strong> Critical equipment requires more frequent monitoring
                  </small>
                </li>
                <li className="mb-2">
                  <small>
                    <strong>Maintenance Interval:</strong> Set based on manufacturer recommendations
                  </small>
                </li>
                <li className="mb-2">
                  <small>
                    <strong>Specifications:</strong> Add technical details for better tracking
                  </small>
                </li>
                <li>
                  <small>
                    <strong>Location:</strong> Be specific about room or area for easy identification
                  </small>
                </li>
              </ul>
            </div>
